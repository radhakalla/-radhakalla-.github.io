			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="ProductDisplayFasheCategory.php?catid=1" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
								Dresses
							</a>
						</div>
					</div>
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="ProductDisplayFasheCategory.php?catid=4" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
								Sunglasses
							</a>
						</div>
					</div>
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="ProductDisplayFasheCategory.php?catid=2" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
								Watches
							</a>
						</div>
					</div>
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="ProductDisplayFasheCategory.php?catid=5" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
								Footerwear
							</a>
						</div>
					</div>
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						...
						<div class="block1-wrapbtn w-size2">
							<!-- Button -->
							<a href="ProductDisplayFasheCategory.php?catid=3" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
								Bags
							</a>
						</div>
					</div>
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
								<img src="productimages/<?php echo $row["ProId"] ?>.jpg" alt="IMG-PRODUCT">
							...
							<div class="block2-txt p-t-20">
								<a href="product-detail.html" class="block2-name dis-block s-text3 p-b-5">
									<?php echo $row["ProName"] ?> <br/>
									<?php echo $row["ProDescription"] ?>
								</a>

								<span class="block2-price m-text6 p-r-5">
									$<?php echo $row["ProPrice"] ?>.00
								</span>
							</div>
						</div>
					</div>
